            ...
            <ul class="aiz-side-nav-list mb-3 pb-3 border-bottom" data-toggle="aiz-side-menu">
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('dashboard') }}" class="aiz-side-nav-link {{ areActiveRoutes(['dashboard']) }}">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Dashboard') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('purchase_history.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Purchase History') }}</span>
                ...
                @if (addon_is_activated('preorder'))
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Preorders') }}</span>
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('preorder.order_list') }}" class="aiz-side-nav-link {{ areActiveRoutes(['preorder.order_list', 'purchase_history.details']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Customer Preorders') }}</span>
                                </a>
                            </li>
                            @if (get_setting('conversation_system') == 1) 
                                ...
                                <li class="aiz-side-nav-item">
                                    <a href="{{ route('preorder-conversations.customer-index') }}"
                                        ...
                                        <span class="aiz-side-nav-text">{{ translate('Customer Preorder Chats') }}</span>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('digital_purchase_history.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Downloads') }}</span>
                    </a>
                </li>
                ...
                @if (addon_is_activated('refund_request'))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('customer_refund_request') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Refund Requests') }}</span>
                        </a>
                    </li>
                @endif
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('wishlists.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Wishlist') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('compare') }}" class="aiz-side-nav-link {{ areActiveRoutes(['compare']) }}">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Compare') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('followed_seller') }}" class="aiz-side-nav-link {{ areActiveRoutes(['followed_seller']) }}">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Followed Sellers') }}</span>
                    </a>
                </li>
                @endif
                ...
                @if (get_setting('classified_product') == 1)
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('customer_products.index') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Classified Products') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (addon_is_activated('auction'))
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);" class="aiz-side-nav-link">
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Auction') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('auction_product_bids.index') }}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Customer Bidded Products') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                ...
                @if (get_setting('conversation_system') == 1)
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('conversations.index') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Conversations') }}</span>
                ...
                @if (get_setting('wallet_system') == 1)
                    <li class="aiz-side-nav-item">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Wallet') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (addon_is_activated('club_point'))
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('earnng_point_for_user') }}"
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Earning Points') }}</span>
                        </a>
                    </li>
                @endif
                ...
                @if (addon_is_activated('affiliate_system') &&
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="javascript:void(0);"
                            ...
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Affiliate') }}</span>
                            <span class="aiz-side-nav-arrow"></span>
                        </a>
                        <ul class="aiz-side-nav-list level-2">
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('affiliate.user.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['affiliate.user.index','affiliate.payment_settings']) }}">
                                    <span class="aiz-side-nav-text">{{ translate('Customer Affiliate System') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('affiliate.user.payment_history') }}"
                                    class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Customer Payment History') }}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{ route('affiliate.user.withdraw_request_history') }}"
                                    class="aiz-side-nav-link">
                                    <span
                                        class="aiz-side-nav-text">{{ translate('Customer Withdraw Request History') }}</span>
                                </a>
                            </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('support_ticket.index') }}"
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Support Ticket') }}</span>
                        @if ($support_ticket > 0)
                ...
                <li class="aiz-side-nav-item">
                    <a href="{{ route('profile') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profile']) }}">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Profile') }}</span>
                    </a>
                </li>
                ...
                <li class="aiz-side-nav-item">
                    <a href="javascript:void(0)" onclick="account_delete_confirm_modal('{{ route('account_delete') }}')" class="aiz-side-nav-link">
                        ...
                        <span class="aiz-side-nav-text ml-3">{{ translate('Customer Delete My Account') }}</span>
                    </a>
                </li>
                ...
                @else
                    <li class="aiz-side-nav-item mb-3">
                        <div class="p-3 rounded" style="background: #f8f9fb;">
                            <div class="fs-12 text-secondary text-uppercase fw-700 mb-1">{{ translate('Workspace Role') }}</div>
                            <div class="fs-15 fw-700 text-dark">
                                @if (isLogisticsCompany())
                                    {{ translate('Logistics Company') }}
                                @elseif (isCustomsBroker())
                                    {{ translate('Customs Broker') }}
                                @else
                                    {{ translate('Workspace User') }}
                                @endif
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="aiz-side-nav-item">
                        <a href="{{ route('customer.all-notifications') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customer.all-notifications']) }}">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                <path d="M8 0a1 1 0 0 1 1 1v1.18a4.002 4.002 0 0 1 3 3.87V11l1 1v1H2v-1l1-1V7.05a4.002 4.002 0 0 1 3-3.87V1a1 1 0 0 1 1-1h1Z" fill="#b5b5bf"/>
                                <path d="M6 13a2 2 0 0 0 4 0H6Z" fill="#b5b5bf"/>
                            </svg>
                            <span class="aiz-side-nav-text ml-3">{{ translate('Customer Notifications') }}</span>
                        </a>
                    </li>

                    @if (isLogisticsCompany())
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('logistics.conversations.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['logistics.conversations.index', 'logistics.conversations.show']) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M1 2h14v9H6l-4 3v-3H1V2Z" fill="#b5b5bf"/>
                                </svg>
                    ...
                    @if (isCustomsBroker())
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customs.preorder-conversations.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customs.preorder-conversations.index', 'customs.preorder-conversations.show']) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M1 2h14v9H6l-4 3v-3H1V2Z" fill="#b5b5bf"/>
                                </svg>
                                <span class="aiz-side-nav-text ml-3">{{ translate('Preorder Chats') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customs.preorders.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customs.preorders.index', 'customs.preorders.show']) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M2 1h12v14H2V1Zm2 3h8V3H4v1Zm0 3h8V6H4v1Zm0 3h5v-1H4v1Z" fill="#b5b5bf"/>
                                </svg>
                                <span class="aiz-side-nav-text ml-3">{{ translate('Preorder Requests') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('customs.product_queries.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['customs.product_queries.index', 'customs.product_queries.show']) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                    <path d="M2 2h12v10H6l-4 4V2Z" fill="#b5b5bf"/>
                                </svg>
                                <span class="aiz-side-nav-text ml-3">{{ translate('Product Queries') }}</span>
                            </a>
                        </li>
                    @endif
