                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" lang="en" class="form-control" name="hsn_code" value="" placeholder="{{translate('HSN Code')}}" required>
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">
                                    {{ translate('GST Rate (%)') }}
                                </label>
                                <input type="number" lang="en" min="0" value="" step="0.01" placeholder="{{ translate('GST Rate') }}" name="gst_rate" class="form-control" required>
                            </div>
                        </div>
                        @else
                        <div class="card-header">
