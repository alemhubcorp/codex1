            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    <ul class="nav nav-tabs nav-fill border-light language-bar">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-reset @if ($language->code == $lang) active @endif py-3" href="{{ route('auction_product_edit.admin', ['id'=>$product->id, 'lang'=> $language->code] ) }}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" lang="en" class="form-control" name="hsn_code" required value="{{ $product->hsn_code }}" placeholder="{{translate('HSN Code')}}">
                        </div>
                        <div class="form-group mb-3">
                            <label for="name">
                                {{translate('GST Rate (%)')}}
                            </label>
                            <input type="number" lang="en" min="0" value="{{ $product->gst_rate }}" required step="0.01" placeholder="{{ translate('GST Rate') }}" name="gst_rate" class="form-control">
                        </div>
                    </div>
                    @else
                    <div class="card-header">
