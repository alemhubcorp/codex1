                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" lang="en" class="form-control" name="hsn_code" required value="" placeholder="{{translate('HSN Code')}}">
                            </div>
                            <div class="form-group mb-3">
                                <label for="name">
                                    {{translate('GST Rate (%)')}}
                                </label>
                                <input type="number" lang="en" min="0" value="" step="0.01" required placeholder="{{ translate('GST Rate') }}" name="gst_rate" class="form-control">
                            </div>
                        </div>
                        @else
                        <div class="card-header">
