                                ...
                                <div class="pt-3">
                                    <div class="">
                                        <form id="reg-form" class="form-default" role="form" action="{{ route('register') }}" method="POST">
                                            @csrf
                                            @php
                                                $currentUserType = old('user_type', $selectedUserType ?? 'customer');
                                            @endphp

                                            <div class="form-group mb-3">
                                                <label for="user_type" class="fs-12 fw-700 text-soft-dark">{{ translate('Account Type') }}</label>
                                                <select name="user_type" id="user_type" class="form-control rounded-0">
                                                    <option value="customer" {{ $currentUserType == 'customer' ? 'selected' : '' }}>{{ translate('Customer') }}</option>
                                                    <option value="seller" {{ $currentUserType == 'seller' ? 'selected' : '' }}>{{ translate('Seller') }}</option>
                                                    <option value="delivery_boy" {{ $currentUserType == 'delivery_boy' ? 'selected' : '' }}>{{ translate('Delivery Boy') }}</option>
                                                    <option value="logistics_company" {{ $currentUserType == 'logistics_company' ? 'selected' : '' }}>{{ translate('Logistics Company') }}</option>
                                                    <option value="customs_broker" {{ $currentUserType == 'customs_broker' ? 'selected' : '' }}>{{ translate('Customs Broker') }}</option>
                                                </select>
                                            </div>
                                            <!-- Name -->
                                            ...
                                            <div id="seller-registration-fields" class="d-none">
                                                <div class="form-group">
                                                    <label for="shop_name" class="fs-12 fw-700 text-soft-dark">{{ translate('Company / Shop Name') }}</label>
                                                    <input type="text" class="form-control rounded-0" value="{{ old('shop_name') }}" placeholder="{{ translate('Company / Shop Name') }}" name="shop_name" data-seller-required="true">
                                                </div>

                                                <div class="form-group">
                                                    <label for="address" class="fs-12 fw-700 text-soft-dark">{{ translate('Address') }}</label>
                                                    <input type="text" class="form-control rounded-0" value="{{ old('address') }}" placeholder="{{ translate('Address') }}" name="address" data-seller-required="true">
                                                </div>
                                            </div>
                                    ...
                                    <p class="fs-12 text-gray mb-0">
                                        ...
                                        <a href="{{ route('user.login', ['user_type' => $currentUserType]) }}" class="ml-2 fs-14 fw-700 animate-underline-primary">{{ translate('Log In')}}</a>
                                    </p>
                                </div>
                            </div>
                        </div>
