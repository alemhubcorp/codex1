                        ...
                        <li class="list-inline-item d-flex">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu fs-12 p-0 mt-1">
                                    <a class="dropdown-item py-2 px-2 text-dark" href="{{ route('user.login', ['user_type' => 'seller']) }}">
                            ...
                            @auth
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg py-0 rounded-0">
                                    <div class="p-3 bg-light border-bottom">
                                        <h6 class="mb-0">{{ isCustomer() ? translate('Customer Notifications') : translate('Notifications') }}</h6>
                                    </div>
                                                    ...
                                                    <li class="list-group-item">
                                                        <div class="d-flex">
                                                            @include('frontend.user.partials.notification_entry_inner', [
                                                                'notificationRole' => isLogisticsCompany() ? 'logistics' : (isCustomsBroker() ? 'customs' : 'customer'),
                                                                'showCheckbox' => false,
                                                                'showTimestamp' => false,
                                            ...
                                            @empty
                                                <li class="list-group-item">
                                                    <div class="py-4 text-center fs-16">
                                                        {{ isCustomer() ? translate('No customer notifications found') : translate('No notification found') }}
                                                    </div>
                                                </li>
                                            @endforelse
                                        </ul>
                                    ...
                                    <div class="text-center border-top">
                                        <a href="{{ route('customer.all-notifications') }}"
                                            ...
                                            {{ isCustomer() ? translate('View All Customer Notifications') : translate('View All Notifications') }}
                                        </a>
                                    </div>
                                </div>
                            @endauth
                        ...
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            ...
                            @if (isCustomer())
                                ...
                                @if (addon_is_activated('preorder'))
                                    <li class="user-top-nav-element border border-top-0" data-id="1">
                                        <a href="{{ isCustomsBroker() ? route('customs.preorders.index') : (isLogisticsCompany() ? route('logistics.orders.index') : route('preorder.order_list')) }}"
                                            class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                            ...
                                            <span
                                                class="user-top-menu-name has-transition ml-3">{{ isCustomer() ? translate('Customer Preorders') : (isCustomsBroker() ? translate('Customs Preorders') : (isLogisticsCompany() ? translate('Logistics Orders') : translate('Preorder List'))) }}</span>
                                        </a>
                                    </li>
                                @endif
                                ...
                                @if (get_setting('conversation_system') == 1)
                                    <li class="user-top-nav-element border border-top-0" data-id="1">
                                        <a href="{{ isCustomsBroker() ? route('customs.preorder-conversations.index') : (isLogisticsCompany() ? route('logistics.conversations.index') : route('conversations.index')) }}"
                                            class="text-truncate text-dark px-4 fs-14 d-flex align-items-center hov-column-gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                                            ...
                                            <span
                                                class="user-top-menu-name has-transition ml-3">{{ isCustomer() ? translate('Customer Conversations') : (isCustomsBroker() ? translate('Customs Preorder Chats') : (isLogisticsCompany() ? translate('Logistics Messages') : translate('Conversations'))) }}</span>
                                        </a>
                                    </li>
                                @endif
