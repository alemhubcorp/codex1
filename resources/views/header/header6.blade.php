                                ...
                                <div class="dropdown ml-2 mb-1 z-1045 py-1">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right py-0" style="min-width: 200px;">
                                        ...
                                        <div>
                                            ...
                                            <a href="{{ route('user.login', ['user_type' => 'seller']) }}"
                                                class="dropdown-item fs-13 py-2 px-3 hover-bg-light hover-text-primary border-bottom border-soft-light d-flex align-items-center"
                                                style="min-height: 40px;">
                        ...
                        <ul class="list-unstyled no-scrollbar mb-0 text-left">
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                 <a href="{{ isCustomsBroker() ? route('customs.preorders.index') : (isLogisticsCompany() ? route('logistics.orders.index') : route('preorder.order_list')) }}"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3">{{ isCustomer() ? translate('Customer Preorders') : (isCustomsBroker() ? translate('Customs Preorders') : (isLogisticsCompany() ? translate('Logistics Orders') : translate('Preorder List'))) }}</span>
                                </a>
                            </li>
                            @endif
                            ...
                            <li class="user-top-nav-element border border-top-0" data-id="1">
                                 <a href="{{ isCustomsBroker() ? route('customs.preorder-conversations.index') : (isLogisticsCompany() ? route('logistics.conversations.index') : route('conversations.index')) }}"
                                    ...
                                    <span class="user-top-menu-name has-transition ml-3">{{ isCustomer() ? translate('Customer Conversations') : (isCustomsBroker() ? translate('Customs Preorder Chats') : (isLogisticsCompany() ? translate('Logistics Messages') : translate('Conversations'))) }}</span>
                                </a>
                            </li>
                            @endif
