...
class ProductController extends Controller
{
    ...
    {
        $categories = Cache::remember('product_create_categories', 600, function () {
            return Category::where('digital', 0)->get();
        });
        $brands = Cache::remember('product_create_brands', 600, function () {
            return Brand::orderBy('name')->get();
        });
        $attributes = Cache::remember('product_create_attributes', 600, function () {
            return Attribute::orderBy('name')->get();
        });
        $colors = Cache::remember('product_create_colors', 600, function () {
            return Color::orderBy('name')->get();
        });
        $flashDeals = Cache::remember('product_create_flash_deals', 600, function () {
            return FlashDeal::where('status', 1)->get();
        });
        $refundNotes = Cache::remember('product_create_refund_notes', 600, function () {
            return Note::where('note_type', 'refund')->get();
        });
        $warrantyNotes = Cache::remember('product_create_warranty_notes', 600, function () {
            return Note::where('note_type', 'warranty')->get();
        });
        $shippingNotes = Cache::remember('product_create_shipping_notes', 600, function () {
            return Note::where('note_type', 'shipping')->get();
        });
        $deliveryNotes = Cache::remember('product_create_delivery_notes', 600, function () {
            return Note::where('note_type', 'delivery')->get();
        });
        $warranties = Cache::remember('product_create_warranties', 600, function () {
            return Warranty::all();
        });
        $taxes = Cache::remember('product_create_taxes', 600, function () {
            return Tax::where('tax_status', 1)->get();
        });
        ...
        return view('backend.product.products.create', compact(
            'categories',
            'brands',
            'attributes',
            'colors',
