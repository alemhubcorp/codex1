    ...
    */
    ...
    protected function validateLogin(Request $request)
    {
        $request->validate([
            ...
            'user_type' => ['nullable', Rule::in($this->supportedUserTypes())],
    ...
    public function authenticated()
    {
        ...
        if (auth()->user()->user_type == 'admin' || auth()->user()->user_type == 'staff') {
            ...
            return redirect()->route('seller.dashboard');
        } elseif (in_array(auth()->user()->user_type, ['logistics_company', 'customs_broker'])) {
            return redirect()->route(auth()->user()->user_type === 'logistics_company' ? 'logistics.dashboard' : 'customs.dashboard');
        } else {
