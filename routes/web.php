...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
    ...
    Route::get('/logistics/dashboard', 'logistics_dashboard')->name('logistics.dashboard')->middleware(['prevent-back-history']);
    Route::get('/customs/dashboard', 'customs_dashboard')->name('customs.dashboard')->middleware(['prevent-back-history']);
    Route::get('/logistics/orders', 'logistics_orders')->name('logistics.orders.index')->middleware(['prevent-back-history']);
    Route::get('/logistics/orders/{id}', 'logistics_order_show')->name('logistics.orders.show')->middleware(['prevent-back-history']);
    Route::get('/customs/preorders', 'customs_preorders')->name('customs.preorders.index')->middleware(['prevent-back-history']);
    Route::get('/customs/preorders/{id}', 'customs_preorder_show')->name('customs.preorders.show')->middleware(['prevent-back-history']);
    Route::get('/customs/product-queries', 'customs_product_queries')->name('customs.product_queries.index')->middleware(['prevent-back-history']);
    Route::get('/customs/product-queries/{id}', 'customs_product_query_show')->name('customs.product_queries.show')->middleware(['prevent-back-history']);
    Route::put('/customs/product-queries/{id}/reply', 'customs_product_query_reply')->name('customs.product_queries.reply')->middleware(['prevent-back-history']);
    Route::get('/logistics/conversations', [ConversationController::class, 'index'])->name('logistics.conversations.index')->middleware(['prevent-back-history']);
    Route::get('/logistics/conversations/{id}', [ConversationController::class, 'show'])->name('logistics.conversations.show')->middleware(['prevent-back-history']);
    Route::post('/logistics/conversations/refresh', [ConversationController::class, 'refresh'])->name('logistics.conversations.refresh')->middleware(['prevent-back-history']);
