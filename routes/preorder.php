...
Route::group([ 'middleware' => ['isPreorder', ]], function () {
    ...
    Route::group(['middleware' => ['user', 'verified', 'unbanned']], function () {
            Route::controller(PreorderController::class)->group(function () {
                ...
                Route::get('/customs/order-details/{id}', 'order_details')->name('customs.order_details');
                Route::put('/customs/order-details/{id}', 'order_update')->name('customs.order_update');
            ...
            Route::controller(PreorderConversationController::class)->group(function () {
                ...
                Route::get('/customs/conversations', 'customerIndex')->name('customs.preorder-conversations.index');
                Route::get('/customs/conversation/{id}/show', 'customerShow')->name('customs.preorder-conversations.show');
                Route::post('/customs/conversations/message-reply', 'messageReplyCustomer')->name('customs.preorder-conversations.reply');
            });
        });
    });
